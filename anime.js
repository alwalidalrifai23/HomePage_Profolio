...
var anime = function() {
    var t = {
      ...
      , c = function(t) {
        return r.array(t) ? t : (r.string(t) && (t = o(t) || t),
      ...
      , g = function(t) {
        var n, e, r, t = /hsl\((\d+),\s*([\d.]+)%,\s*([\d.]+)%\)/g.exec(t), a = parseInt(t[1]) / 360, u = parseInt(t[2]) / 100, i = parseInt(t[3]) / 100, o = function(t, n, e) {
            return 0 > e && (e += 1),
            e > 1 && (e -= 1),
            1 / 6 > e ? t + 6 * (n - t) * e : .5 > e ? n : 2 / 3 > e ? t + (n - t) * (2 / 3 - e) * 6 : t
        };
        if (0 == u)
            n = e = r = i;
        else
      ...
      , E = function(t) {
        var e = p(t, n);
        return "alternate" !== e.direction || e.loop || (e.loop = 1),
        e
    }
      , P = function(t, e) {
        var a = [];
      ...
      , S = function(t, n) {
        var e = void 0;
        if (t.currentTime = Math.min(n, t.totalDuration),
        ...
        t.interpolations.forEach(function(r) {
            ...
            r.animatables.forEach(function(n) {
                var u = n.id;
                switch (t.values[r.name][u] = r.currentValues,
                r.type) {
                case "css":
      ...
      , $ = function(t) {
        var n = {};
        return n.targets = s(r.array(t.targets) ? t.targets.map(c) : c(t.targets)),
        n.animatables = k(n.targets),
        n.settings = E(t),
        n.properties = P(t, n.settings),
        n.interpolations = q(n.animatables, n.properties),
        n.totalDuration = Math.max.apply(Math, n.interpolations.map(function(t) {
      ...
      , T = function(t) {
        if (t && t.targets) {
            ...
            return e.tick = function() {
                ...
                S(n, e.current),
                e.current >= n.totalDuration ? (n.settings.loop ? (e.start = +new Date,
                r.number(n.settings.loop) && n.settings.loop--,
                "alternate" === n.settings.direction && n.interpolations.forEach(B),
                e.raf = requestAnimationFrame(e.tick)) : (n.ended = !0,
                n.settings.complete ? n.settings.complete(n) : n.pause()),
                e.last = 0) : e.raf = requestAnimationFrame(e.tick))
            }
            ,
            n.set = function(t) {
